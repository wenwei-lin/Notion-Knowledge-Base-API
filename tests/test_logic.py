    ...
    def testCreatePodcast(self):
        assert (
            self.command.execute(
                {
                    "title": "1.2 总序｜舶来的“年轻学科”如何适应中国的土壤？",
                    "description": "作为引领课程开场的总序，来自北京大学社会学系的周飞舟教授和渠敬东教授，在本讲中将以对谈的形式，整体性地讲述“什么是社会学”，以及如何用社会学的眼光来理解中国问题。\n在某种意义上，社会学关切的并不仅仅是当下问题，更有“通古今之变”的宏大视野，让我们通过社会学，找到过去和未来之间的一个连接点，从而搭建起观察中国的另一种眼光。",
                    "type": "Podcast",
                    "published": "2022-04-18",
                    "duration": 5,
                    "language": "Chinese",
